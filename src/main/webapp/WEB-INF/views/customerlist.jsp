...
<body>
	<div class="container">
		...
		<a href="/CustomerRelationshipManagement/customer/add"
			...
			<tbody>
				<c:forEach items="${customerModel}" var="customer">
					<tr>
						...
						<td><a
							href="/CustomerRelationshipManagement/customer/update?id=${customer.customerId}"
							class="btn btn-info btn-sm">Update</a> <a
							href="/CustomerRelationshipManagement/customer/delete?id=${customer.customerId}"
